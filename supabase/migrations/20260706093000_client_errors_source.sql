...
ALTER TABLE public.client_errors ADD COLUMN IF NOT EXISTS source TEXT DEFAULT 'client';

CREATE INDEX IF NOT EXISTS idx_client_errors_source ON public.client_errors (source, last_seen_at DESC);
