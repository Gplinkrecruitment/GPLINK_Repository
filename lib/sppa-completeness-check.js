...
var IDENTIFY_SYSTEM_PROMPT = [
  ...
  '',
  'The documents are attached in order; refer to them by their 1-based position.',
  'Return ONLY valid JSON with this exact shape:',
  '{',
  '  "documents": [',
  '    {',
...
async function identifySppaDocuments(docs, opts) {
  ...
  for (var i = 0; i < docs.length; i++) {
    ...
    var b64 = d.buffer.toString('base64');
    totalB64 += b64.length;
...
module.exports = { checkSppaCompleteness, parseCompletenessResponse, COMPLETENESS_SYSTEM_PROMPT, isOnlyAltCvOutstanding, identifySppaDocuments, parseIdentifyResponse, IDENTIFY_SYSTEM_PROMPT };
