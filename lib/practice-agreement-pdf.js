 ...
 * @param {string} [params.legalEntityName] - Full legal registered entity name.
 * @param {string} [params.abnAcn] - ABN or ACN label (e.g. "ABN 12 345 678 901").
 * @param {string} [params.signerJobTitle] - Job title of the person who signed.
...
async function stampAgreementExecutionPage(params) {
  ...
  var legalEntityName = params.legalEntityName;
  var abnAcn = params.abnAcn;
  var signerJobTitle = params.signerJobTitle;
  ...
  var signedByValue = (signedName || '') +
    (signerJobTitle ? ', ' + signerJobTitle : '') +
    ' (authorised to sign on behalf of the practice)';

  var lines = [
    { label: 'Practice: ', value: practiceName || '' },
    { label: 'Legal entity: ', value: legalEntityName || '' },
    { label: 'ABN / ACN: ', value: abnAcn || '' },
    { label: 'Signed by: ', value: signedByValue },
