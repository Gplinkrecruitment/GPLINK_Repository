...
function normalizeFacebookGpLead(body, allowedFormIds) {
  ...
  if (nativeValue && typeof nativeValue === 'object' && nativeValue.field_data) {
    ...
    countryQuestionKind = resolvedCountry.questionKind || 'none';
    ...
    countryQuestionKind = flatResolved.questionKind || 'none';
  ...
  return {
    ...
    countryRecognised,
    // registration | training | none - a training answer may never decline a doctor.
    countryQuestionKind,
