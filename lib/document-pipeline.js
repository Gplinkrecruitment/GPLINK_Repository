...
//
// Sourced from RACGP's Expedited Specialist Pathway Fellowship Admission Policy
// and the Medical Board's accepted-qualification list:
//   GB  MRCGP from August 2007 onwards WITH a GMC-issued CCT
//   IE  MICGP from 2009 onwards with a CSCST for training taken in Ireland
//   NZ  FRNZCGP from 2012 onwards following GPEP
// NZ was 2010-01-01 here until 2026-09-18; both sources say 2012 and the owner
// confirmed the correction. No NZ doctor existed in the database at the time,
// so nothing was re-gated by the change.
const PEP_DATE_CUTOFFS = { GB: '2007-08-01', IE: '2009-01-01', NZ: '2012-01-01' };
