...
function buildExtractionPrompt(emailMeta, opts) {
  ...
  return [
    ...
    '{"deadline":"YYYY-MM-DD"|null,"reference":"string"|null,"items":[{"title":"","detail":"","gp_instructions":"","sub_items":[],"owner":"gp|team","mode":"upload|request_institution|team","institution":"","kind":""}]}',
    '',
