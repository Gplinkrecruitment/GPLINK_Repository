...
function buildExtractionPrompt(emailMeta, opts) {
  ...
  return [
    ...
    '{"deadline":"YYYY-MM-DD"|null,"reference":"string"|null,"items":[{"title":"","detail":"","gp_instructions":"","team_instructions":"","sub_items":[],"owner":"gp|team","mode":"upload|request_institution|team","institution":"","kind":""}]}',
    '',
...
function normalizeExtraction(parsed, ctx) {
  ...
  for (var i = 0; i < rawItems.length; i++) {
    ...
    if (norm.title && !isSubmissionInfoItem(norm)) items.push(norm);
  }
