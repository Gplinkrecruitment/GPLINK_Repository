...
function progressTracker() {
  const rows = [
    { n: '✓', bg: '#16a34a', color: '#fff', title: 'Consultation booked', desc: "Done — you're on the calendar.", strong: false, here: false },
    { n: '2', bg: '#2563eb', color: '#fff', title: "Create your free account · you're here", desc: '2 minutes. Unlocks your roadmap and saves your call notes to your file.', strong: true, here: true },
    { n: '3', bg: '#fff', color: '#94a3b8', title: 'Matched to a practice', desc: 'Real roles that fit what you told us you want.', strong: false, here: false },
    { n: '4', bg: '#fff', color: '#94a3b8', title: 'Guided registration', desc: 'AHPRA, AMC & visa — done with you, step by step.', strong: false, here: false },
    { n: '5', bg: '#fff', color: '#94a3b8', title: 'Working in Australia', desc: 'The reason you booked the call in the first place.', strong: false, here: false },
  ];
...
module.exports = { buildBookerNudgeEmail, BOOKER_NUDGE_STEP_COUNT, withRef };
