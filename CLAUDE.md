...
- Includes `scripts/agent-bridge.js` so the live super-admin dashboard can proxy to Codex and Claude CLIs running on the local Mac, either through direct localhost fetches or a secure relay token when the browser blocks localhost access
