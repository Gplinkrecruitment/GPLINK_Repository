...
describe('cache buster + dead CSS pruned', () => {
  ...
  it('ceo-dashboard.html loads the bumped board stylesheet (a stale pin serves pre-board CSS from cache)', () => {
    // Bumped to 20260722a by the Task 12 Contracts tab (scoped textarea/label
    // styling so its note field and field labels render outside a drawer/modal).
    // Any edit to css/ceo-ats.css must move this forward.
    expect(ceoHtml).toContain('/css/ceo-ats.css?v=20260722a');
