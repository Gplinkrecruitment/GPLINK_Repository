...
describe('wiring', () => {
  ...
  it('the module is precached and the busters moved together', () => {
    ...
    expect(sw).toContain('var VERSION = "20260918d"');
    expect(read('pages/app-shell.html')).toContain('/js/app-shell.js?v=20260918a');
    expect(sw).toContain('/js/app-shell.js?v=20260918a');
  });
});
