...
const db = {
  user_profiles: [
    { user_id: GP1.userId, email: GP1.email, first_name: 'Test', last_name: 'DoctorOne', zoho_candidate_id: null },
    { user_id: GP2.userId, email: GP2.email, first_name: 'Test', last_name: 'DoctorTwo', zoho_candidate_id: null }
  ],
  user_state: [
